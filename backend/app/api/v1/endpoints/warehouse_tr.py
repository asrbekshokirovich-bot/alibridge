...
from app.domain.enums import CustodyEventType, HolderType, ProductStatus, Role
...
async def warehouse_tr_stats(
    ...
    return {
        "arriving_today": 0,        # TODO: flight landing tracking
        "in_warehouse": in_wh,
        "ready_for_pickup": ready_for_courier,  # mijoz qabul uchun tayyor
    }
